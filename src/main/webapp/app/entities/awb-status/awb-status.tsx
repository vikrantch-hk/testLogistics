...
import { getSearchEntities, getEntities } from './awb-status.reducer';
import { IAwbStatus } from 'app/shared/model/awb-status.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IAwbStatusProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IAwbStatusState {
  search: string;
}

export class AwbStatus extends React.Component<IAwbStatusProps, IAwbStatusState> {
  state: IAwbStatusState = {
    search: ''
  };
