...
import { getSearchEntities, getEntities } from './product-source-destination-mapping.reducer';
import { IProductSourceDestinationMapping } from 'app/shared/model/product-source-destination-mapping.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IProductSourceDestinationMappingProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IProductSourceDestinationMappingState {
  search: string;
}

export class ProductSourceDestinationMapping extends React.Component<
  IProductSourceDestinationMappingProps,
  IProductSourceDestinationMappingState
> {
  state: IProductSourceDestinationMappingState = {
    search: ''
  };
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="product-source-destination-mapping-heading">
