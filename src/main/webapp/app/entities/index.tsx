...
const Routes = ({ match }) => (
  <div>
    <Switch>
      ...
      <Route path={`${match.url}/product-group`} component={ProductGroup} />
      ...
      <Route path={`${match.url}/pickup-status`} component={PickupStatus} />
      <Route path={`${match.url}/awb`} component={Awb} />
      <Route path={`${match.url}/city`} component={City} />
      <Route path={`${match.url}/city-courier-tat`} component={CityCourierTAT} />
      <Route path={`${match.url}/country`} component={Country} />
      <Route path={`${match.url}/courier-pickup-info`} component={CourierPickupInfo} />
