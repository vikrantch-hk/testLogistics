...
import { getEntities } from './region-type.reducer';
import { IRegionType } from 'app/shared/model/region-type.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IRegionTypeProps {
  getEntities: ICrudGetAllAction<IRegionType>;
  regionTypeList: IRegionType[];
  match: any;
}

export class RegionType extends React.Component<IRegionTypeProps> {
  componentDidMount() {
