...
import { getSearchEntities, getEntities } from './courier-attributes.reducer';
import { ICourierAttributes } from 'app/shared/model/courier-attributes.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICourierAttributesProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICourierAttributesState {
  search: string;
}

export class CourierAttributes extends React.Component<ICourierAttributesProps, ICourierAttributesState> {
  state: ICourierAttributesState = {
    search: ''
  };
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="courier-attributes-heading">
          Courier Attributes
