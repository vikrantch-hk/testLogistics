...
import { getSearchEntities, getEntities } from './courier-group.reducer';
import { ICourierGroup } from 'app/shared/model/courier-group.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICourierGroupProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICourierGroupState {
  search: string;
}

export class CourierGroup extends React.Component<ICourierGroupProps, ICourierGroupState> {
  state: ICourierGroupState = {
    search: ''
  };
