...
import { getSearchEntities, getEntities } from './courier-channel.reducer';
import { ICourierChannel } from 'app/shared/model/courier-channel.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICourierChannelProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICourierChannelState {
  search: string;
}

export class CourierChannel extends React.Component<ICourierChannelProps, ICourierChannelState> {
  state: ICourierChannelState = {
    search: ''
  };
