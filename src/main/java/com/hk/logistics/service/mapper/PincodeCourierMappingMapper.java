 ...
 */
@Mapper(componentModel = "spring", uses = {PincodeMapper.class, CourierAttributesMapper.class, VendorWHCourierMappingMapper.class, SourceDestinationMappingMapper.class})
