...
public class ProductResourceIntTest {
    ...
    private static final Boolean DEFAULT_IS_SERVICEABLE = false;
    private static final Boolean UPDATED_IS_SERVICEABLE = true;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            .name(DEFAULT_NAME)
            .isServiceable(DEFAULT_IS_SERVICEABLE);
        return product;
    }
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.isIsServiceable()).isEqualTo(DEFAULT_IS_SERVICEABLE);
    }
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isServiceable").value(hasItem(DEFAULT_IS_SERVICEABLE.booleanValue())));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.isServiceable").value(DEFAULT_IS_SERVICEABLE.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            .name(UPDATED_NAME)
            .isServiceable(UPDATED_IS_SERVICEABLE);
        ...
        assertThat(testProduct.isIsServiceable()).isEqualTo(UPDATED_IS_SERVICEABLE);
    }
