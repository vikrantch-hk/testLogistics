...
import com.hk.test.config.audit.AuditEventConverter;
import com.hk.test.domain.PersistentAuditEvent;
...
import static com.hk.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
