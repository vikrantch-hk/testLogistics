...
describe('Entities reducer tests', () => {
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_COURIER_LIST),
          FAILURE(ACTION_TYPES.FETCH_COURIER),
          FAILURE(ACTION_TYPES.CREATE_COURIER),
          FAILURE(ACTION_TYPES.UPDATE_COURIER),
          FAILURE(ACTION_TYPES.DELETE_COURIER)
        ],
        'error message',
        state => {
          expect(state).to.contain({
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_COURIER_LIST actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_COURIER_LIST)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_COURIER_LIST),
    ...
    it('dispatches ACTION_TYPES.FETCH_COURIER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_COURIER)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_COURIER),
          payload: resolvedObject
        }
      ];
    ...
    it('dispatches ACTION_TYPES.CREATE_COURIER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.CREATE_COURIER)
        },
        {
          type: SUCCESS(ACTION_TYPES.CREATE_COURIER),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.UPDATE_COURIER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.UPDATE_COURIER)
        },
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_COURIER),
          payload: resolvedObject
        },
        {
          type: REQUEST(ACTION_TYPES.FETCH_COURIER_LIST)
    ...
    it('dispatches ACTION_TYPES.DELETE_COURIER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.DELETE_COURIER)
        },
        {
          type: SUCCESS(ACTION_TYPES.DELETE_COURIER),
          payload: resolvedObject
